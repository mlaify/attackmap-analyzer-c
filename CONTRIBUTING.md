# Contributing to `attackmap-analyzer-c`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-c.git
cd attackmap-analyzer-c
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-c/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-c/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-c`, you agree that your contributions will be
